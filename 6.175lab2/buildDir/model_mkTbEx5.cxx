...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_tb_randomA_initialized__h3065;
	 tUInt8 DEF_INST_top_DEF_tb_randomB_initialized__h3441;
	 ...
	 DEF_INST_top_DEF_tb_randomA_initialized__h3065 = INST_top.INST_tb_randomA_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1 = !DEF_INST_top_DEF_tb_randomA_initialized__h3065;
	 ...
	 INST_top.DEF_x__h5648 = INST_top.INST_tb_read_count.METH_read();
	 INST_top.DEF__read__h162 = INST_top.INST_test_folded_i.METH_read();
	 INST_top.DEF_test_folded_i_EQ_8___d111 = (INST_top.DEF__read__h162) == (tUInt8)8u;
	 INST_top.DEF_tb_read_count_08_EQ_128___d109 = (INST_top.DEF_x__h5648) == 128u;
	 INST_top.DEF_CAN_FIRE_RL_tb_read = INST_top.INST_tb_operands_fifo.METH_i_notEmpty() && (!(INST_top.DEF_tb_read_count_08_EQ_128___d109) && INST_top.DEF_test_folded_i_EQ_8___d111);
	 INST_top.DEF_WILL_FIRE_RL_tb_read = INST_top.DEF_CAN_FIRE_RL_tb_read;
	 DEF_INST_top_DEF_tb_randomB_initialized__h3441 = INST_top.INST_tb_randomB_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomB_every_1 = !DEF_INST_top_DEF_tb_randomB_initialized__h3441;
	 INST_top.DEF_WILL_FIRE_RL_tb_randomB_every_1 = INST_top.DEF_CAN_FIRE_RL_tb_randomB_every_1;
	 INST_top.DEF_CAN_FIRE_RL_test_folded_mulStep = (INST_top.DEF__read__h162) < (tUInt8)8u;
	 INST_top.DEF_WILL_FIRE_RL_test_folded_mulStep = INST_top.DEF_CAN_FIRE_RL_test_folded_mulStep;
	 ...
	 INST_top.DEF_x__h3859 = INST_top.INST_tb_feed_count.METH_read();
	 INST_top.DEF_x_wget__h3317 = INST_top.INST_tb_randomB_zaz.METH_wget();
	 INST_top.DEF_x_wget__h2940 = INST_top.INST_tb_randomA_zaz.METH_wget();
	 INST_top.DEF_v__h3447 = INST_top.INST_tb_randomB_zaz.METH_whas() ? INST_top.DEF_x_wget__h3317 : (tUInt8)0u;
	 INST_top.DEF_v__h3071 = INST_top.INST_tb_randomA_zaz.METH_whas() ? INST_top.DEF_x_wget__h2940 : (tUInt8)0u;
	 INST_top.DEF_IF_tb_randomA_zaz_whas__9_THEN_tb_randomA_zaz__ETC___d89 = (INST_top.DEF_v__h3071) == (tUInt8)128u;
	 INST_top.DEF_IF_tb_randomB_zaz_whas__6_THEN_tb_randomB_zaz__ETC___d90 = (INST_top.DEF_v__h3447) == (tUInt8)128u;
	 INST_top.DEF_CAN_FIRE_RL_tb_feed = ((DEF_INST_top_DEF_tb_randomA_initialized__h3065 && (DEF_INST_top_DEF_tb_randomB_initialized__h3441 && ((INST_top.DEF_IF_tb_randomA_zaz_whas__9_THEN_tb_randomA_zaz__ETC___d89 || INST_top.DEF_IF_tb_randomB_zaz_whas__6_THEN_tb_randomB_zaz__ETC___d90) || INST_top.INST_tb_operands_fifo.METH_i_notFull()))) && (!((INST_top.DEF_x__h3859) == 128u) && (INST_top.DEF__read__h162) == (tUInt8)9u)) && !(INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1);
	 ...
	 if (INST_top.DEF_WILL_FIRE_RL_tb_read)
	   INST_top.RL_tb_read();
	 if (INST_top.DEF_WILL_FIRE_RL_test_folded_mulStep)
	   INST_top.RL_test_folded_mulStep();
...
time_t MODEL_mkTbEx5::get_creation_time()
{
  ...
  /* Thu Jul 25 19:45:12 UTC 2024 */
  return 1721936712llu;
}
