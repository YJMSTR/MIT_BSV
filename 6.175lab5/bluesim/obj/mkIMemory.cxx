...
void MOD_mkIMemory::init_symbols_0()
{
  ...
  init_symbol(&symbols[3u], "memInit_initialized__h239", SYM_DEF, &DEF_memInit_initialized__h239, 1u);
}
...
tUInt32 MOD_mkIMemory::METH_req(tUInt32 ARG_req_a)
{
  tUInt32 DEF_i__h241;
  tUInt32 PORT_req;
  DEF_i__h241 = (tUInt32)(65535u & (ARG_req_a >> 2u));
  PORT_req = INST_mem.METH_sub(DEF_i__h241);
  return PORT_req;
}
...
tUInt8 MOD_mkIMemory::METH_RDY_req()
{
  ...
  DEF_memInit_initialized__h239 = INST_memInit_initialized.METH_read();
  DEF_CAN_FIRE_req = DEF_memInit_initialized__h239;
...
tUInt8 MOD_mkIMemory::METH_RDY_init_request_put()
{
  ...
  DEF_memInit_initialized__h239 = INST_memInit_initialized.METH_read();
  DEF_CAN_FIRE_init_request_put = !DEF_memInit_initialized__h239;
...
tUInt8 MOD_mkIMemory::METH_init_done()
{
  ...
  DEF_memInit_initialized__h239 = INST_memInit_initialized.METH_read();
  PORT_init_done = DEF_memInit_initialized__h239;
...
unsigned int MOD_mkIMemory::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "memInit_initialized__h239", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
...
void MOD_mkIMemory::vcd_defs(tVCDDumpType dt, MOD_mkIMemory &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF_memInit_initialized__h239) != DEF_memInit_initialized__h239)
      {
	vcd_write_val(sim_hdl, num, DEF_memInit_initialized__h239, 1u);
	backing.DEF_memInit_initialized__h239 = DEF_memInit_initialized__h239;
      }
      ++num;
